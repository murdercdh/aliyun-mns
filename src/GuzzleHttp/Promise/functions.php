<?php
namespace AliyunMNS\GuzzleHttp\Promise;
 ...
 *     AliyunMNS\GuzzleHttp\Promise\queue()->run();
 * }
 * </code>
 *
 * @return TaskQueue
 ...
 *
 * @return array
 * @see AliyunMNS\GuzzleHttp\Promise\inspect for the inspection state array format.
 */
 ...
 *
 * This prommise is rejected with a {@see AliyunMNS\GuzzleHttp\Promise\AggregateException}
