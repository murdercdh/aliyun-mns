...
use AliyunMNS\GuzzleHttp\Cookie\CookieJar;
use AliyunMNS\GuzzleHttp\Promise;
...
class Client implements ClientInterface
{
     ...
     *   AliyunMNS\GuzzleHttp\Promise\PromiseInterface that is fulfilled with a
     ...
     *
     * @see \AliyunMNS\GuzzleHttp\RequestOptions for a list of available request options.
     */
